...
//    private LoadBalancerClient loadBalancerClient;
    ...
    public ResponseEntity<?> getFallbackProject(@RequestBody List<Resource> resourceList, @PathVariable Integer id) {
        return new ResponseEntity<>("Please try again later!", HttpStatus.NOT_FOUND);
    }
